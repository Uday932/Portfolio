...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="signin.html" class="nav-item nav-link active">Devenir client</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Devenir client</h1>
            <div class="d-inline-flex align-items-center text-white">
            </div>
        </div>
    </div>
    ...
    <div class="login" style="left: 10%;padding: 50px 0px 120px 50px;position:relative;display:inline-block;">
        ...
        <form action="/faster-1.0.0v3/" method="POST" name="identification" style="padding-bottom: 20px;">
            <div style="width: 320px;line-height: 19px;">E-mail<input type="text" required="required" value="email" placeholder="E-mail" name="email" style="float:right;"></div><br>
            <div style="width: 320px;line-height: 19px;">Mot de passe<input type="password" required="required" value="mdp" placeholder="Mot de passe" name="mdp" style="float:right;"></div><br>
            <input type="HIDDEN" name="cmd" value="LOGIN"><input type="HIDDEN" name="sessid" value="qoxnkq45immy0m45z2h2vfrz">
            <button type="submit" name="submitEE" value="Valider" id="login_button" style="margin-left: 152px;">S'inscrire</button>
        </form>
    </div>
