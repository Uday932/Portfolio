...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">À propos</h1>
            <div class="d-inline-flex align-items-center text-white">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <h6 class="text-primary text-uppercase font-weight-bold">À propos</h6>
                    <h1 class="mb-4">Le début d'une nouvelle histoire</h1>
                    <p class="mb-4">ChronoFlop, entreprise privée (SA) de livraison de colis crée par 2 collaborateurs dans le but de corriger certains problèmes remarqués sur plusieurs entreprises de livraison.
                         Aujourd’hui elle compte plus de 150 employés avec plusieurs entrepôt en France métropolitaine.
                    </p>
