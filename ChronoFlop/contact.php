            ...
            <div class="row">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    <div class="bg-primary text-dark text-center p-4">
                        <h4 class="m-0"><i class="fa fa-map-marker-alt text-white mr-2"></i>1 Rue de la Livraison, Paris</h4>
                    </div>
                    <iframe style="width: 100%; height: 470px;"
                        src="https://www.google.com/maps/embed/v1/place?q=Big+Dal,+Route+de+Mitry,+Aulnay-sous-Bois,+France&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                        frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="col-lg-7">
                    <h6 class="text-primary text-uppercase font-weight-bold">Nous contacter</h6>
                    <h1 class="mb-4">Contactez-nous en cas de question</h1>
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            ...
                            // Envoie un e-mail à l'adresse spécifiée
                            echo $to = 'uday.bhavsar.sio@gmail.com';
                            echo $subject = '';
                            echo $body = "Nom: $name\n\nEmail: $email\n\nSujet: $subject\n\nMessage:\n$message";
                            echo $headers = "From: $email";

                            if (mail($to, $subject, $body, $headers)) {
                                // Redirige l'utilisateur vers une page de confirmation si le mail a été envoyé avec succès
                                echo "Le mail à été envoyé avec succès!";
                            } else {
                                // Affiche une erreur si le mail n'a pas pu être envoyé
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="about.php"><i class="fa fa-angle-right mr-2"></i>À propos</a>
                            <a class="text-white mb-2" href="service.php"><i class="fa fa-angle-right mr-2"></i>FAQ</a>
                            <a class="text-white mb-2" href="price.php"><i class="fa fa-angle-right mr-2"></i>Nos tarifs</a>
                        </div>
                    </div>
                </div>
            </div>
...
Designed by <a href="https://htmlcodex.com">HTML Codex</a>
            ...
            <div class="col-lg-6 text-center text-md-right">
                <ul class="nav d-inline-flex">
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="cgu.php">CGU</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="cgv.php">CGV</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="service.php">FAQ</a>
                    </li>
                </ul>
            </div>
        </div>
