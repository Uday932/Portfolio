...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="client.php" class="nav-item nav-link active">Espace client</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mb-5">Espace Client.</h1>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-5 col-md-6 mb-5">
                ...
                <p>Si vous voulez vous tenir au courant des dernieres nouveautés de ChronoFlop vous pouvez vous inscrire a la Newsletter</p>
                <div class="w-100">
